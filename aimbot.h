...
// JUST DEFINE THE OLD ACTOR ID TO EXAMPLE 0x1747774548 to == (printif(0x1118xF)
// AS YOU SEE THEY USE A MEMORY AND NOT A MOUSE AIM BUT THEY USE A MEMORY INTERNAL AIMBOT WITHOUT ANY SIGSS YEEES ITS POSSIBLE 
